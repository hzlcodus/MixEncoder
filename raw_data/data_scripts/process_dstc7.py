...
root_path = "/data/xxx/fast_match/"
# ---------------------------------------------------------------------------
# process train data for bi models, each record is ( context, its best response)
if not os.path.exists(root_path + "dataset/string_bi_train_dstc7"):
	...
	whole_datasets.save_to_disk(root_path + "dataset/string_bi_train_dstc7")
	print("Datasets is saved at " + root_path + "dataset/string_bi_train_dstc7")

# ---------------------------------------------------------------------------
# process dev data, each record is ( context, 100 candidates (best at last))
if not os.path.exists(root_path + "dataset/string_dev_dstc7"):
	...
	whole_datasets.save_to_disk(root_path + "dataset/string_dev_dstc7")
	print("Datasets is saved at " + root_path + "dataset/string_dev_dstc7")

# ---------------------------------------------------------------------------
# process test data, each record is (context, 100 candidates (best at last))
if not os.path.exists(root_path + "dataset/string_test_dstc7"):
	...
	whole_datasets.save_to_disk(root_path + "dataset/string_test_dstc7")
	print("Datasets is saved at " + root_path + "dataset/string_test_dstc7")

# ---------------------------------------------------------------------------
# process train data for cross model, each record is (context, 100 candidates (best at last))
# if not os.path.exists(root_path + "dataset/string_cross_train_dstc7"):
#
...
# 	whole_datasets.save_to_disk(root_path + "dataset/string_cross_train_dstc7")
# 	print("Datasets is saved at " + root_path + "dataset/string_cross_train_dstc7")
