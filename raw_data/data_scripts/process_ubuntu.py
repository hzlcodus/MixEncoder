...
if not os.path.exists(root_path + "dataset/string_bi_train_ubuntu"):
	bi_train_dict = {}
	bi_train_a = []
	bi_train_b = []
	bi_train_idx = []
	...
	whole_datasets.save_to_disk(root_path + "dataset/string_bi_train_ubuntu")
	print("Datasets is saved at" + root_path + "dataset/string_bi_train_ubuntu")


# ---------------------------------------------------------------------------
# process dev data, each record is ( context, 100 candidates (best at last))
if not os.path.exists(root_path + "dataset/dataset/string_dev_ubuntu"):
	dev_dict = {}
	...
	whole_datasets.save_to_disk(root_path + "dataset/string_dev_ubuntu")
	print(root_path + "dataset/string_dev_ubuntu")

# ---------------------------------------------------------------------------
# process test data, each record is (context, 100 candidates (best at last))
if not os.path.exists(root_path + "dataset/string_test_ubuntu"):
	dev_dict = {}
	...
	whole_datasets = Dataset.from_dict(dev_dict)
	whole_datasets.save_to_disk(root_path + "dataset/string_test_ubuntu")
	print("Datasets is saved at" + root_path + "dataset/string_test_ubuntu")


# ---------------------------------------------------------------------------
# process training data for cross models
if not os.path.exists(root_path + "dataset/string_cross_train_ubuntu"):
	...
	whole_datasets.save_to_disk(root_path + "dataset/string_cross_train_ubuntu")
	print("Datasets is saved at" + root_path + "dataset/string_cross_train_ubuntu")
