...
def process_save_data(this_data, split_name):
	...
	whole_datasets.save_to_disk("/data/xxx/TaskSpecificMemory/nlp_task/dataset/string_" + split_name + "_yahooqa")
	print("Datasets is saved at /data/xxx/TaskSpecificMemory/nlp_task/dataset/string_" + split_name + "_yahooqa")
